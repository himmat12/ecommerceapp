...
class DmartItemsCard extends StatefulWidget {
  @override
  _DmartItemsCardState createState() => _DmartItemsCardState();
}

class _DmartItemsCardState extends State<DmartItemsCard> {
  List<Item> dmartItems = [
    Item(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  ProductPage(itemClass: dmartItems[index])));
                    },
                    child: Column(
                      children: <Widget>[
                        Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Text(
                                          dmartItems[index].totalPrice, //price
                                          textAlign: TextAlign.justify,
                                          style: TextStyle(
                                              fontSize: 15.0,
                                              color: Theme.of(context)
